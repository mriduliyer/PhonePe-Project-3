...
check_server_name_exists = (
    "SELECT EXISTS(SELECT 1 FROM nginx_server_hostname WHERE server_name = %s);"
)
...
metric_by_requestsize = (
    "SELECT path, request_size FROM nginx_logs ORDER BY request_size DESC LIMIT 5;"
)
